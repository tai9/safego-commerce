              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full max-w-md">
                <div className="relative flex-1">
                  <span className="absolute left-4 top-1/2 transform -translate-y-1/2">
                    ...
                    >
                      <path
                        d="M18 0H2C0.9 0 0 0.9 0 2V14C0 15.1 0.9 16 2 16H18C19.1 16 20 15.1 20 14V2C20 0.9 19.1 0 18 0ZM18 2V2.67L10 7.79L2 2.67V2H18ZM2 14V5.33L9.25 10.04C9.661 10.3 10.164 10.442 10.678 10.4422C11.191 10.4424 11.694 10.3007 12.105 10.04L18 6.33V14H2Z"
                        fill="currentColor"
                      />
                    </svg>
                  </span>
                ...
                <Button
                  type="submit"
                  className="bg-white hover:bg-white/90 text-black rounded-full font-semibold py-3 px-6 w-full sm:w-auto transition-opacity"
                >
