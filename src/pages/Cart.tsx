        ...
        <div className="flex-1">
          ...
          <div className="flex justify-between items-center">
            <div className="flex border rounded-full overflow-hidden">
              ...
              <span className="px-3 py-1 flex items-center justify-center">{item.quantity}</span>
              <button 
                onClick={() => updateQuantity(item.id, item.quantity + 1)}
                className="px-3 py-1 bg-gray-100"
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        ...
        <div className="container mx-auto px-4 py-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-8 md:mb-12">YOUR CART</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="md:col-span-2">
                {isMobile ? (
                  ...
                  cartItems.map(item => <DesktopCartItem key={item.id} item={item} />)
                )}
              </div>
              ...
              <div className="bg-white rounded-lg border p-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex space-x-2">
                    <Input
                      type="text"
                      placeholder={isMobile ? "Add promo code" : "Enter promo code"}
                      value={promoCode}
          ...
          {isMobile && (
            <div className="mt-12 bg-black rounded-lg text-white p-6">
              <h3 className="text-xl font-bold mb-2 text-center">STAY UP TO DATE ABOUT OUR LATEST OFFERS</h3>
