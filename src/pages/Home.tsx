  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="bg-gray-100 dark:bg-secondary py-8 md:py-16">
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="order-1 md:order-2 relative animate-fade-in">
                ...
                <div
                  className="absolute bottom-12 right-12 animate-pulse"
            ...
            <div className="mt-16 border-t border-gray-200 pt-10">
              <div className="grid grid-cols-2 md:grid-cols-5 gap-6 items-center justify-items-center">
                <div className="transform hover:scale-105 transition-transform">
                  <h4 className="font-heading font-bold text-xl cursor-pointer">
                    VERSACE
                  </h4>
                </div>
                <div className="transform hover:scale-105 transition-transform">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Link
                  ...
                  className="rounded-lg overflow-hidden relative bg-gray-100 aspect-[4/3] hover:opacity-90 transition-opacity"
                >
                  <img
                  ...
                  <div className="absolute bottom-4 left-4">
                    <span className="font-medium text-xl bg-white px-4 py-2 rounded-lg">
                      Casual
                    </span>
                  </div>
                </Link>
                ...
                >
                  <img
                    src="https://plus.unsplash.com/premium_photo-1674777843441-04dd6cd672ee?q=80&w=2574&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    alt="Formal style"
                    className="w-full h-full object-cover"
                  />
                  <div className="absolute bottom-4 left-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  "I'm absolutely thrilled with my purchase! The quality
                  exceeded my expectations, and the style is perfect. Will
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  "This is a follow-up to my previous order. Once again, SHOP.CO
                  has delivered a high-quality product that fits perfectly. The
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  "I've been searching for the perfect jeans for months, and I
                  finally found them here! The fit is fantastic, and they
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  "The shirts I ordered are great quality and look exactly like
                  the pictures. The only reason for 4 stars is that shipping
