...
const SettingsManagement = () => {
  ...
  // Create form instances for each settings category
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label htmlFor="storeName" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Store Name</label>
                      <Input 
                        id="storeName"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="storeEmail" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Store Email</label>
                      <Input 
                        id="storeEmail"
                        type="email"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label htmlFor="storePhone" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Phone Number</label>
                      <Input 
                        id="storePhone"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="storeAddress" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Address</label>
                      <Input 
                        id="storeAddress"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="space-y-2">
                      <label htmlFor="storeCurrency" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Default Currency</label>
                      <select 
                        id="storeCurrency"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="storeLanguage" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Default Language</label>
                      <select 
                        id="storeLanguage"
                        className="w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="storeTimeZone" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Timezone</label>
                      <select 
                        id="storeTimeZone"
                        className="w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="storeDescription" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Store Description</label>
                    <Textarea 
                      id="storeDescription"
                      rows={4}
                ...
                <CardContent className="space-y-6">
                  <div className="rounded-lg border p-4">
                    ...
                    {paymentSettings.enablePaypal && (
                      <div className="mt-4 space-y-3 border-t pt-3">
                        <div className="space-y-2">
                          <label htmlFor="paypalEmail" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">PayPal Email</label>
                          <Input 
                            id="paypalEmail"
                  ...
                  <div className="rounded-lg border p-4">
                    ...
                    {paymentSettings.enableStripe && (
                      <div className="mt-4 space-y-3 border-t pt-3">
                        <div className="space-y-2">
                          <label htmlFor="stripeKey" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Stripe API Key</label>
                          <Input 
                            id="stripeKey"
                  ...
                  <div className="rounded-lg border p-4">
                    ...
                    {paymentSettings.enableBankTransfer && (
                      <div className="mt-4 space-y-3 border-t pt-3">
                        <div className="space-y-2">
                          <label htmlFor="bankDetails" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Bank Account Details</label>
                          <Textarea 
                            id="bankDetails"
                            rows={4}
                ...
                <CardContent className="space-y-6">
                  <div className="rounded-lg border p-4">
                    ...
                    {shippingSettings.enableFreeShipping && (
                      <div className="mt-4 space-y-3 border-t pt-3">
                        <div className="space-y-2">
                          <label htmlFor="freeShippingThreshold" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Minimum Order Amount ($)</label>
                          <Input 
                  ...
                  <div className="rounded-lg border p-4">
                    ...
                    {shippingSettings.enableFlatRate && (
                      <div className="mt-4 space-y-3 border-t pt-3">
                        <div className="space-y-2">
                          <label htmlFor="flatRateAmount" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Flat Rate Amount ($)</label>
                          <Input 
                            id="flatRateAmount"
                            type="number"
                  ...
                  <div className="rounded-lg border p-4">
                    ...
                    {shippingSettings.enableLocalPickup && (
                      <div className="mt-4 space-y-3 border-t pt-3">
                        <div className="space-y-2">
                          <label htmlFor="localPickupAddress" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Pickup Address</label>
                          <Textarea 
                  ...
                  <div className="rounded-lg border p-4">
                    ...
                    {shippingSettings.enableInternationalShipping && (
                      <div className="mt-4 space-y-3 border-t pt-3">
                        <div className="space-y-2">
                          <label htmlFor="internationalRate" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">International Rate ($)</label>
                          <Input 
              ...
              <Form {...emailForm}>
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <label htmlFor="emailHeader" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Email Header HTML</label>
                      <Textarea 
                        id="emailHeader"
                        rows={4}
                    ...
                    <div className="space-y-2">
                      <label htmlFor="emailFooter" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Email Footer HTML</label>
                      <Textarea 
                        id="emailFooter"
                        rows={4}
